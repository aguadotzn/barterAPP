...
\section{Tecnologías}\label{tecnologias}
 ...
 \subsection{Front-end: Angular 2/4}\label{tecnologias-angular}
...
\imagen{angularclihelloworld}{Vista \emph{App hola Mundo}. Elaboración propia.}
