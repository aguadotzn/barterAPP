...
\imagen{uxschema}{\footnotesize{Esquema \emph{UI, UX IxD}. Fuente  \url{https://dealfuel.com}.}}
...
\imagen{meanjs}{\footnotesize{Esquema \emph{MEAN}. Fuente: \url{https://kambrica.com}.}} \label{mean}
...
\imagen{mvcschema2}{\footnotesize{Dibujo \emph{MVC}\cite{mvc}. Fuente: \url{https://artima.com}.}}
...
\imagen{arqchema}{\footnotesize{Arquitectura simplificada \emph{MVC}\cite{mvc}. Fuente: Elaboración propia.}}
...
\imagen{funcionamiento}{\footnotesize{Funcionamient web básico \emph{MVC}\cite{mvc}. Fuente: \url{https://w3c.es}.}}\label{funcionamiento}
