...
Los requerimientos mínimos para empezar a trabajar en el proyecto son:
\begin{enumerate}
	\item Instalar Node.js y MongoDB.
	\item Instala Angular CLI
		\lstset{language=C, breaklines=true, basicstyle=\footnotesize}
		\begin{lstlisting}[frame=single]
		npm i -g @angular/cli
    	\end{lstlisting}
	\item Desde el directorio raíz del proyecto (vía línea de comandos) instalar las dependencias necesarias
\end{enumerate}
