...
\begin{enumerate}
	...
	\item Ahora, sabiendo la tecnología a usar, nodejs para el servidor en este caso, se crea un fichero de  \textbf{boxfile.yml} en la raiz del proyecto\citep{nano2} .
