...
\begin{itemize}
	...
	\item \textbf{/client/app}: Carpeta App
		\begin{itemize}
		\item \textbf{/client/app/_directives}: 
		\item \textbf{/client/app/_guards}:
		\item \textbf{/client/app/_models}: 
		\item \textbf{/client/app/_services}: 
		\item \textbf{/client/app/enviroments}: 
		\item \textbf{/client/app/pages/}:  
			\begin{itemize}
			\item \textbf{/client/app/pages/angular_calendar}:  
			\item \textbf{/client/app/pages/home}:  
			\item \textbf{/client/app/pages/login}:  
			\item \textbf{/client/app/pages/register}:  
			\item \textbf{/client/app/pages/welcome}:  
			\end{itemize}
