...
var DeferredLoader = (function () {
    ...
    DeferredLoader.prototype.ngAfterViewInit = function () {
        ...
        this.documentScrollListener = this.renderer.listenGlobal('window', 'scroll', function () {
            if (_this.shouldLoad()) {
                _this.load();
...
DeferredLoader = __decorate([
    ...
    __metadata("design:paramtypes", [core_1.ElementRef, domhandler_1.DomHandler, core_1.Renderer, core_1.ViewContainerRef])
], DeferredLoader);
