import { ElementRef, OnInit, OnDestroy, EventEmitter, Renderer, ChangeDetectorRef } from '@angular/core';
...
export declare class SplitButton implements OnInit, OnDestroy {
    ...
    constructor(el: ElementRef, domHandler: DomHandler, renderer: Renderer, router: Router, cd: ChangeDetectorRef);
    ngOnInit(): void;
