import { ElementRef, AfterContentInit, AfterViewInit, AfterViewChecked, OnInit, OnDestroy, ViewContainerRef, EventEmitter, Renderer, QueryList, TemplateRef, ChangeDetectorRef } from '@angular/core';
